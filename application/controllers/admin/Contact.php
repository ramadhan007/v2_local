...
class Contact extends CI_Controller {
	...
	function _get_html($row=array())
	{
		...
		$array_data = $this->userModel->get_list();
		$html['user_id'] = html_select('user_id', $array_data, set_value('user_id', ($row ? $row->user_id : '')), ' - Pilih User - ');
