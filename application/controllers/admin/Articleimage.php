...
class Articleimage extends CI_Controller {

	//controller main properties
	var $controller = "admin/articleimage";
	var	$title = "article image";
	...
	function __construct(){
		...
		// load model
		$this->load->model('articleImageModel','',TRUE);
		$this->model = new articleImageModel;
