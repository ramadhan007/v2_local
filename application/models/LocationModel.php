...
class LocationModel extends CI_Model {
	...
	function get_paged_list($limit=10, $offset=0, $cari=''){
		$select = "*, fc_count_device(id) as list, fn_get_list_item_short('published',published) as published_text,
					fn_get_list_item_icon('published',published) as published_icon,
					fn_get_list_item_class('published',published) as published_class";
		return model_get_paged_list($this->table, $limit, $offset, $select, 'name', 'asc', $cari, array('name'));
	}
