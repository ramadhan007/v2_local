...
class ListCatModel extends CI_Model {
	
	// table name
	private $table= 'tb_list_cat';
	...
	function get_paged_list($limit=10, $offset=0, $cari=''){
		return model_get_paged_list($this->table, $limit, $offset, "*, fc_count_list_item(id) as list", 'name', 'asc', $cari, array('name'));
	}
