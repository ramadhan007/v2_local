...
class ArticleImageModel extends CI_Model {
	
	// table name
	private $table= 'tb_article_image';
	...
	function get_paged_list($limit = 10, $offset = 0, $cari='', $article_id){
		return model_get_paged_list($this->table, $limit, $offset, 'id, name, title, path, published', 'name', 'asc', $cari, array('title','name'), 'article_id', $article_id);
	}
