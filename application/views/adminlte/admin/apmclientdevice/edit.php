        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="<?php echo $action; ?>">
                    ...
                    <div class="form-group<?=form_group_error('device_id');?>">
                        <label>Device</label>
                        <?=$html['device_id'];?>
                        <?=form_error('device_id');?>
                    </div>
                    <div class="form-group<?=form_group_error('appium_port');?>">
                        <label>Appium Port</label>
                        <input class="form-control" type="text" name="appium_port" value="<?php echo set_value('appium_port',(isset($row) ? $row->appium_port : '')); ?>"/>
                        <?php echo form_error('appium_port'); ?>
                    </div>
