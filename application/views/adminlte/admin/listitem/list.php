...
$(document).ready(function(e) {
    $(document).keyup(function(e){
		if(e.keyCode == 27) {
			parent.closeModal('listItemModal');
		}
	});
});

parent.document.getElementById('listItemModalTitle').innerHTML='<?php echo str_replace("'","\'",$this->view['toptitle']); ?>';
parent.document.getElementById('span_list_count_<?php echo $this->session->userdata($this->controller.'_list_cat_id'); ?>').innerHTML = 'Edit List (<?php echo $total_rows; ?>)';
