...
$(document).ready(function(e) {
    $(document).keyup(function(e){
		if(e.keyCode == 27) {
			parent.closeModal('widgetModal');
		}
	});
});

parent.document.getElementById('widgetModalTitle').innerHTML='<?php echo str_replace("'","\'",$this->view['toptitle']); ?>';
parent.document.getElementById('span_widget_count_<?php echo $this->session->userdata($this->controller.'_article_id'); ?>').innerHTML = '<?php echo $total_rows; ?>';
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group" style="float:right">
                    ...
                    <a class="btn btn-success btn-sm" href="javascript:submitTask('copy');"><i class="fa fa-file-o fa-lg"></i> Copy</a>
