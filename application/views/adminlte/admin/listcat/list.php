...
<!-- List Item Modal -->
<div class="modal large autoheight fade" id="listItemModal" style="width:auto; height:auto;">
    <div class="modal-dialog" style="width:60%;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                "button">&times;</button>
                <h4 id="listItemModalTitle" class="modal-title"></h4>
            </div>
...
function openListItemModal(listcat_id)
{
	$('#listItemModal iframe').attr('src','<?php echo site_url($this->config->item('admin').'/listitem/setcatid'); ?>/' + listcat_id);
