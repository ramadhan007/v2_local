...
<form id="frm_admin" class="form-inline" method="post" action="<?php echo current_url(); ?>" role="form">
      ...
      <table class="table table-striped table-hover">
      	<thead>
            <tr>
                ...
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Loc</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Oper</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle">Journey</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Cell</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Lat</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Long</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">RT</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Signal Strength(dBm)</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Signal Quality(dB)</th>
				<!-- <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">BER</th> -->
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Resp(s)</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Ping(ms)</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Loss</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Status</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1"><i class="fa fa-image"></i></th>
                <th rowspan="2" style="text-align:center; vertical-align:middle">Error&nbsp;On</th>
                <th colspan="3" style="text-align:center;" width="1">NVT</th>
                <th rowspan="2" style="text-align:center; vertical-align:middle" width="1">Date&nbsp;Time</th>
            </tr>
            <tr>
            	<th width="1">Sig</th>
                <th width="1">Resp</th>
