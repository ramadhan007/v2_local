      ...
      <table class="table table-striped table-hover">
      	<thead>
            <tr>
                ...
                <th style="text-align:center; vertical-align:middle" width="1"><i class="fa fa-image"></i></th>
            </tr>
        </thead>
        <tbody id="list_tbody">
...
function doExportData(){
	...
	var export_location_id = encodeURIComponent($('#export_location_id').val());
	var export_operator_id = encodeURIComponent($('#export_operator_id').val());
