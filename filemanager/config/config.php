...
if($sekolah_id){
	$tmp_dir = 'userfiles/sekolah/'.$sekolah_id;	
}else{
	if($_SESSION['usertype']<=2){
		$tmp_dir = 'userfiles';
	}else{
		$tmp_dir = 'userfiles/user/'.$_SESSION['user_id'];
	}
}
