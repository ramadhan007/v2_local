...
if($token=='vuMy+U)z@Bscqa$.^N'){
	...
	$sql = "SELECT fn_insert_monitor_journey_nvt('$monitor_journey_id','$network_type','$cellid','$signal_level','$response_time','$latency','$packet_loss','$status','$message','$monitor_datetime','$repeat_no') AS id";
